...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "https://paqueta977.github.io"}})
...
def predict():
    ...
    try:
        ...
        # ประมวลผลภาพก่อนทำนาย
        image = image.resize((224, 224))
        image = apply_clahe(image)  # ใช้ CLAHE
        image = adjust_gamma(image, gamma=1.2)  # ใช้ Gamma Correction
